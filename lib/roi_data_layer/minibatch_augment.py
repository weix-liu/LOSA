...
from roi_data_layer.randaugment import RandAugment
...
def get_minibatch(roidb, num_classes,seg_return=False,is_training=False):
  ...
  im_blob, im_scales = _get_image_blob(roidb, random_scale_inds,is_training)
