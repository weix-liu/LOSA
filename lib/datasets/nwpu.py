...
class nwpu(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'nwpu' + '_' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.NWPU
        ...
        #{'airplane': 757, 'storagetank': 655, 'baseballdiamond': 390, 'tenniscourt': 524, 'basketballcourt': 159,
        # 'groundtrackfield': 163, 'vehicle': 598, 'bridge': 124, 'harbor': 224, 'ship': 302}
