...
class dronevehicle_inf(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'dronevehicle_inf' + '_' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.dronevehicle_inf
        if self._image_set == 'test':
            self._devkit_path = '/data/liuweixing/DroneVehicle/test/inf'
