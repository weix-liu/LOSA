...
class dronevehicle_rgb(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'dronevehicle_rgb' + '_' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.dronevehicle_rgb
        if self._image_set == 'test':
            self._devkit_path = '/data/liuweixing/DroneVehicle/test/rgb'
        self._data_path = self._devkit_path
        self._classes = ('__background__',  # always index 0
                         'car','fcar','bus','truck','van')
        # {'car': 1, 'fcar': 1, 'bus': 1, 'truck': 1, 'van': 1}
