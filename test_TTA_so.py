    ...
    if True:
        ...
        for i in range(num_images):
            ...
            (
                ...
                rois_label_s_fake,base_feat,base_feat1,base_feat2
            ) = fasterRCNN(im_data, im_info, gt_boxes, num_boxes,vis=vis)
            ...
            if i == 16:
                ...
                with open('inf00017_before_base1feat.json', 'w') as f:
                    json.dump(feat1.tolist(), f)
                with open('inf00017_before_base2feat.json', 'w') as f:
                    json.dump(feat2.tolist(), f)
            ...
            if i==212:
                ...
                feat1 = feat1.detach().cpu().numpy()
                feat2 = feat2.detach().cpu().numpy()
                with open('inf00213_before_base1feat.json', 'w') as f:
                    json.dump(feat1.tolist(), f)
                with open('inf00213_before_base2feat.json', 'w') as f:
                    json.dump(feat2.tolist(), f)
